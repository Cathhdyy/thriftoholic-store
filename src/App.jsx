...
const CATEGORIES = [
  ...
  { name: "Thrifted Clothes", desc: "Vintage & Y2K finds", icon: Shirt, color: "bg-rose-50/50 border-rose-100", iconColor: "text-rose-500", iconBg: "bg-rose-100" },

  { name: "Accessories", desc: "Cute little additions", icon: Sparkles, color: "bg-orange-50/50 border-orange-100", iconColor: "text-orange-500", iconBg: "bg-orange-100" },

  { name: "Jewelry", desc: "Rings & necklaces", icon: Gem, color: "bg-amber-50/50 border-amber-100", iconColor: "text-amber-500", iconBg: "bg-amber-100" },

  { name: "Keychains", desc: "Bags & keys", icon: Key, color: "bg-pink-50/50 border-pink-100", iconColor: "text-pink-500", iconBg: "bg-pink-100" }
...
export default function App() {
  ...
  return (
    ...
    <div className="min-h-screen bg-[#faf9f8] font-sans text-gray-800 selection:bg-pink-200 selection:text-pink-900 overflow-x-hidden">
        ...
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="flex justify-between items-center h-14 sm:h-16">
            ...
            <div className="hidden sm:flex sm:space-x-8 sm:items-center">
              ...
              <a href="#about" className="text-sm font-medium text-gray-600 hover:text-pink-500 transition-colors">Our Story</a>
        ...
        {isMenuOpen && (
          ...
          <div className="sm:hidden bg-white border-b border-pink-100 absolute w-full shadow-lg">
            ...
            <div className="pt-2 pb-4 space-y-1 px-4">
              ...
              <a href="#about" onClick={() => setIsMenuOpen(false)} className="block py-3 text-sm font-medium text-gray-700 border-b border-gray-50">Our Story</a>
            ...
            {CATEGORIES.map((cat, idx) => {
              ...
              return (
                ...
                <a
                  ...
                  className={`group relative flex flex-col items-center sm:items-start text-center sm:text-left p-5 sm:p-8 rounded-[2rem] border ${cat.color} overflow-hidden transition-all duration-300 hover:shadow-lg hover:-translate-y-2 cursor-pointer`}

                >

                  <div className={`w-14 h-14 sm:w-16 sm:h-16 rounded-full ${cat.iconBg} flex items-center justify-center mb-4 sm:mb-6 group-hover:scale-110 transition-transform duration-300 shadow-sm`}>

                    <Icon className={`${cat.iconColor}`} size={28} />

                  </div>

                  <h3 className="text-base sm:text-xl font-bold text-gray-900 mb-1 sm:mb-2 group-hover:text-pink-500 transition-colors">{cat.name}</h3>

                  <p className="text-xs sm:text-sm text-gray-600">{cat.desc}</p>

                  

                  <div className="hidden sm:block absolute top-8 right-6 opacity-0 -translate-x-4 group-hover:opacity-100 group-hover:translate-x-0 transition-all duration-300">

                    <ArrowRight className={cat.iconColor} size={24} />
      ...
      <section id="about" className="py-16 sm:py-24 relative overflow-hidden bg-gradient-to-b from-white to-pink-50/50">
        ...
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-8 items-center">
            ...
            <div className="order-2 lg:order-1 flex flex-col items-center lg:items-start text-center lg:text-left">
              ...
              <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-pink-100/80 text-pink-600 text-xs sm:text-sm font-medium mb-6 backdrop-blur-sm border border-pink-200 shadow-sm">
              ...
              <h2 className="text-3xl sm:text-4xl lg:text-5xl font-serif font-bold text-gray-900 mb-6 leading-tight">
                ...
                <span className="text-transparent bg-clip-text bg-gradient-to-r from-pink-500 to-amber-400">with a big heart.</span>
              ...
              <div className="grid grid-cols-2 gap-4 w-full sm:w-auto">
                ...
                <div className="flex items-center gap-3 p-4 rounded-2xl bg-white border border-pink-100 shadow-sm hover:shadow-md transition-shadow">
                  ...
                  <span className="font-bold text-sm sm:text-base text-gray-800">Sustainable <br/> <span className="font-normal text-xs text-gray-500">Fashion</span></span>

                </div>

                <div className="flex items-center gap-3 p-4 rounded-2xl bg-white border border-pink-100 shadow-sm hover:shadow-md transition-shadow">

                  <div className="w-10 h-10 sm:w-12 sm:h-12 rounded-full bg-pink-100 flex items-center justify-center text-pink-600 shrink-0">

                    <Heart size={20} />

                  </div>

                  <span className="font-bold text-sm sm:text-base text-gray-800">Local Love <br/> <span className="font-normal text-xs text-gray-500">From Sikkim</span></span>
      ...
      <section id="how-to-order" className="py-12 sm:py-20 bg-pink-50/50 border-t border-pink-100/50">
